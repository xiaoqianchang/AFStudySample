...
-keep class com.chang.oobe.android.data.** {*;}
-keep class com.chang.oobe.android.engine.** {*;}
-keep class com.chang.oobe.android.ui.** {*;}
-keep class com.chang.oobe.android.utils.** {*;}
-keep class com.chang.oobe.android.view.** {*;}
